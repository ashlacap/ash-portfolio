...
const CaseStudyDetail = ({ slug, onBack, backLabel = "Back to Work" }) => {
  ...
  const studies = {
    ...
    samsung: {
      ...
      role: "Marketing Strategy & Analytics MBA Intern · Remote",
      bgColor: "#1a1410",
      accentColor: "#7ecaef",
      intro: "Built product launch campaigns and social analytics for CartZilla, the viral 400-horsepower street-legal shopping cart attraction in Las Vegas.",
      overview: "As Marketing Strategy & Analytics MBA Intern at Social View Agency, I helped build social and product launch campaigns for the CartZilla brand while pairing that creative work with rigorous post-promotional analysis, feeding business intelligence and marketing insights back to the wider team.",
      outcomes: [
        { metric: "200+", label: "Social posts analyzed" },
        { metric: "Multi", label: "Launch campaigns built" },
        { metric: "BI", label: "Insights delivered to teams" },
      ],
      bullets: [
        "Created social media campaigns that promoted the CartZilla brand, the viral 400-horsepower, street-legal giant shopping cart attraction in Las Vegas.",
        "Collaborated with Business Development and Content to set up product launch campaigns, including SEO, relevant metadata, copy, creative briefs, product images and artwork.",
        "Analyzed over 200 social posts against historical data sets (e.g. sales performance) and identified content improvement opportunities; created an action plan for implementing new changes.",
        "Performed post-promotional analysis to assess promotion effectiveness against KPIs to support sales projections, supporting other teams with business intelligence and marketing insights.",
      ],
      coverImage: "/sva-cartzilla-cover.png",
      tools: ["Campaign Strategy", "SEO", "Post-Promotional Analysis", "Meta Business Suite", "Creative Briefs"],
    },
    "hr-block": {
      ...
      intro: "Statistical A/B testing and marketing analytics that lowered acquisition costs and raised conversion.",
      overview: "As Data Analyst supporting H&R Block's marketing team, I designed statistical A/B tests on email and landing page messaging, then visualized the results in Python and SQL to give every team clear, actionable data insights that informed business decisions and drove revenue growth.",
      outcomes: [
      ...
      bullets: [
        ...
        "Visualized marketing analytics with Python/SQL and provided data insights to all teams, which informed business decisions and enabled revenue growth.",
      ],
      tools: ["Python", "SQL", "A/B Testing", "Statistical Analysis"],
    },
    agsm: {
